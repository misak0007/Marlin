...
#define STRING_CONFIG_H_AUTHOR "(Smart, Poseidon-XL-RAMPS)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Poseidon"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // POSEIDON XL
  #define  DEFAULT_Kp 14.59
  #define  DEFAULT_Ki 0.62
  #define  DEFAULT_Kd 86.05
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //poseidon duo
  #define  DEFAULT_bedKp 158.46
  #define  DEFAULT_bedKi 8.81
  #define  DEFAULT_bedKd 712.67
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 128.1541, 128.1667, 800, 280.00 }
